...
let mapMachine = [ marioMap, firstMap, secondMap, batMap, mushroomMap, yoshiMap ]

for (let i = 0; i < mapMachine.length; i++) {
  const allMaps = mapMachine[i]




function initAutocomplete() {
    let map = new google.maps.Map(allMaps.firstMapMap, {
  ...
  function initAutocompleteOne() {
    let map = new google.maps.Map(document.getElementById("mapOne"), {
      center: { lat: -33.8688, lng: 151.2195 },
      zoom: 13,
      mapTypeId: "roadmap",
      streetViewControl: false,
